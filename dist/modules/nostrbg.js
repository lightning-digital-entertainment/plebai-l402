...
function genPostImage() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const randomRow = (0, helpers_1.readRandomRow)(process.env.UPLOAD_PATH + 'bgprompts.csv');
            const promptInjection = randomRow.replace(/"/g, '') + process.env.BG1 + getRandomWord(wordsArray);
            const imageURL = yield (0, createImage_1.createImage)(promptInjection, 512, 768, true);
            if (imageURL === null)
                return;
